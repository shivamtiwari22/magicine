...
// Open home apis
routers.get(
  "/single-medicine/:slug",
  checkoutAuth,
  HomeController.SingleMedicine
);
...
routers.get(
  "/single-product/:slug",
  checkoutAuth,
  HomeController.SingleProduct
);
routers.get(
  "/single-surgical/:slug",
  checkoutAuth,
  HomeController.SingleSurgical
);
...
routers.post(
  "/update-profile",
  uploadProduct("public/user/images").single("profile_pic"),
  checkUserAuth,
...
routers.get(
  "/add-update-address",
  checkUserAuth,
  AuthController.AddOrUpdateAddress
);
routers.get("/all-prescription", checkUserAuth, AuthController.getPrescription);
routers.post(
  "/upload-prescription",
  uploadProduct("public/user/prescription").single("file"),
  checkUserAuth,
  AuthController.uploadPrescription
);
...
routers.post(
  "/verify-coupon/:coupon",
  checkoutAuth,
  CartController.verifyCoupon
);
...
routers.post(
  "/post-prescription",
  checkUserAuth,
  CustomerPolicyController.postPrescription
);
